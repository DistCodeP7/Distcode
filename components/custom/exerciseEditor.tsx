...
export default function ExerciseEditor({
    ...
    const [activeFilePath, setActiveFilePath] = useState<string | null>("/template/main.go");
    ...
    const problemWithProtocol = useMemo(() => {
        const protocolCode = codeFolder.files["/proto/protocol.go"] ?? "// protocol.go missing";
                    ...
                    <>
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            <div className="flex-1 overflow-y-auto p-2">
                                {rightTab === "problem" && <MarkdownPreview content={problemWithProtocol} />}
                                {rightTab === "solution" && (
                                    <Editor file={{ path: "solution.go", name: "solution.go", type: "file", content: solutionMarkdown }}
                                            setEditorContent={() => {}}
